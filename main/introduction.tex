...
\begin{enumerate}
	\item Design a user experience workflow document which highlights key aspects of the app\textsc{\char13}s UI
	\item Create an Android mobile app with the following components:
		...
		\end{itemize}
	\item Devise a business model utilising Maurya\textsc{\char13}s Lean Canvas methodology consisting of:
		\begin{itemize}
...
\begin{itemize}
	...
	\item Cost -- the group has been set an initial budget of \pound100 which cannot be exceeded
